...
caminho = r'C:\Users\guiev\OneDrive\Documentos\CienciadeDados\Falencia_Bancos.csv'
failures = pd.read_csv(caminho, sep=',', encoding='latin-1')
...
plt.xlabel("Ano")
plt.ylabel("Numeor de falencias")
